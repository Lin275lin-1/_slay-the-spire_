...
func initialize(stats: CharacterStats) -> void:
	...
	tween.tween_callback(func(): run_stats.add_potion(preload("res://entities/potions/肌肉药水.tres")))
	tween.tween_interval(1.0)
	tween.tween_callback(func(): run_stats.add_potion(preload("res://entities/potions/敏捷药水.tres")))
	tween.tween_interval(1.0)
	tween.tween_callback(func(): run_stats.add_potion(preload("res://entities/potions/力量药水.tres")))
	tween.tween_interval(1.0)
