...
func initialize(stats: CharacterStats) -> void:
	...
	#tween.tween_interval(1.0)
	tween.tween_callback(func(): run_stats.add_relic(preload("res://entities/relics/shop/肮脏地毯.tres")))
	tween.tween_interval(1.0)
	tween.tween_callback(func(): run_stats.add_relic(preload("res://entities/relics/colorless/转经轮.tres")))
	tween.tween_interval(1.0)
	tween.tween_callback(func(): run_stats.add_relic(preload("res://entities/relics/shop/熔岩灯.tres")))
	tween.tween_interval(1.0)
	tween.tween_callback(func(): run_stats.add_relic(preload("res://entities/relics/colorless/白兽雕像.tres")))
	tween.tween_interval(1.0)
