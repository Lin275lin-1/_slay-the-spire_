...
func initialize(stats: CharacterStats) -> void:
	...
	#tween.tween_interval(1.0)
	tween.tween_callback(func(): run_stats.add_relic(preload("res://entities/relics/ancient_neow/奥数卷轴.tres")))
	tween.tween_interval(1.0)
	tween.tween_callback(func(): run_stats.add_relic(preload("res://entities/relics/ancient_neow/轰鸣海螺.tres")))
	tween.tween_interval(1.0)
	tween.tween_callback(func(): run_stats.add_relic(preload("res://entities/relics/ancient_neow/金色珍珠.tres")))
	tween.tween_interval(1.0)
	tween.tween_callback(func(): run_stats.add_relic(preload("res://entities/relics/ancient_neow/营养牡蛎.tres")))
	tween.tween_interval(1.0)
