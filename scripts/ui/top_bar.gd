...
func initialize(stats: CharacterStats) -> void:
	...
	tween.tween_callback(func(): run_stats.add_potion(preload("res://entities/potions/精炼混沌.tres")))
	tween.tween_interval(1.0)
	tween.tween_callback(func(): run_stats.add_potion(preload("res://entities/potions/马萨雷斯的赠礼.tres")))
	tween.tween_interval(1.0)
