...
func initialize(stats: CharacterStats) -> void:
	...
	tween.tween_callback(func(): run_stats.add_potion(preload("res://entities/potions/欧洛巴斯之酸.tres")))
	tween.tween_interval(1.0)
	tween.tween_callback(func(): run_stats.add_potion(preload("res://entities/potions/复制药水.tres")))
	tween.tween_interval(1.0)
	tween.tween_callback(func(): run_stats.add_potion(preload("res://entities/potions/镣铐药水.tres")))
	tween.tween_interval(1.0)
